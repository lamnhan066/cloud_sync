...
class InProgress<M> extends SyncState<M> {
...
class FetchingLocalMetadata<M> extends SyncState<M> {
...
class FetchingCloudMetadata<M> extends SyncState<M> {
...
class ScanningCloud<M> extends SyncState<M> {
...
class ScanningLocal<M> extends SyncState<M> {
...
class SavingToCloud<M> extends SyncState<M> {
...
class SavedToCloud<M> extends SyncState<M> {
...
class SavingToLocal<M> extends SyncState<M> {
...
class SavedToLocal<M> extends SyncState<M> {
...
class SyncCompleted<M> extends SyncState<M> {
...
class SyncError<M> extends SyncState<M> {
...
class SyncCancelled<M> implements SyncState<M> {
